        ...
        FROM 
          (
            SELECT 
              ...
              cum_tested, 
              rank() over(
                partition by state_cumulative.state_id 
                order by 
                  state_cumulative.date_1 desc
              ) 
            FROM 
              state_cumulative 
...
ORDER BY 
  ...
  CASE WHEN $1 = 'Vaccinated' THEN "Vaccinated" END -- Case when $1='Vaccinated' and $2='Descending' then "Vaccinated" desc end
