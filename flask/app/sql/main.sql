...
Select date_1,sum(cum_Confirmed) as cum_Confirmed,sum(cum_Recovered) as cum_Recovered,sum(cum_Deceased) as cum_Deceased, sum(cum_Other) as cum_Other, sum(Active) as active
