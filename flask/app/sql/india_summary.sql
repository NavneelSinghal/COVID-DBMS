...
from(
  Select date_1,
        ...
        (cum_Confirmed-cum_Recovered-cum_Deceased-cum_Other)/cum_Confirmed as a1,
        ...
        (cum_Confirmed-cum_Recovered-cum_Deceased-cum_Other)/Population*100000 as a7,
  ...
  from(
    Select date_1,
          cum_Confirmed-lag(cum_Confirmed) over(order by date_1) as cum_Confirmed,
          cum_Recovered-lag(cum_Recovered) over(order by date_1) as cum_Recovered,
          cum_Deceased-lag(cum_Deceased) over(order by date_1) as cum_Deceased,
          cum_Other-lag(cum_Other) over(order by date_1) as cum_Other,
          cum_Tested-lag(cum_Tested) over(order by date_1) as cum_Tested,
    ...
    from ( 
      ...
      from(
        ...
        from India_Cumulative left outer join India_Vaccine_Cumulative
          on India_Cumulative.date_1=India_Vaccine_Cumulative.date_1
      ) as temp1, India_population
