...
ORDER BY 
  ...
  CASE WHEN $2 = 'Confirmed Cases' THEN "Confirmed Cases" END, 
  -- Case when $1='Confirmed Cases' and $2='Descending' then "Confirmed Cases" desc end,
  CASE WHEN $2 = 'Recovered Cases' THEN "Recovered Cases" END, 
  -- Case when $1='Recovered Cases' and $2='Descending' then "Recovered Cases" desc end,
  CASE WHEN $2 = 'Deceased Cases' THEN "Deceased Cases" END, 
  -- Case when $1='Desceased Cases' and $2='Descending' then "Desceased Cases" desc end,
  CASE WHEN $2 = 'Active Cases' THEN "Active Cases" END -- Case when $1='Active Cases' and $2='Descending' then "Active Cases" desc end,
  ;
